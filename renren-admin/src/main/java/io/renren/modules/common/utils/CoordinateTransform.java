...
public class CoordinateTransform {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CoordinateTransform.class);
    ...
    /**
     *  GPS转WGS84
     *  纬度 DDFF.FFFF Wgs84=DD+FFFFFF/60
     *  经度 DDDFF.FFFF Wgs84=DDD+FFFFFF/60
     * @param lat
     * @return
     */
    public static String transferGps(String lat) {
        try {
            String str[] = lat.split("\\.");
            String a = str[0];
            String b = str[1];
            StringBuffer sb=new StringBuffer();
            sb.append(b).insert(2,".");
            int a1 = Integer.parseInt(a);
            double a2 = Double.parseDouble(sb.toString());
            double tt = a2 / 60;
            return (a1 + tt) + "";
            ...
            LOGGER.debug("坐标转换出错" + e);
            return lat;
        }
    }

    public static void main(String[] args) {
        System.err.println(transferGps("103.589462890625"));
        System.err.println(transferGps("30.4333740234375"));
        System.err.println(transferGps("103.589409"));
        System.err.println(transferGps("30.433021"));
